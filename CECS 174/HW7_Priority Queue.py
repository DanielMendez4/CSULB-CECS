#This program will take 2 user inputs: an integer for priority and string for task.
#If user input passes various checks, the priority and task gets appeneded to the todos list.
#Once user enters 0 for priority, the loop ends.
#Using sorted, the todos list gets sorted by priority.
#Finally, getMostImportant will return the task and then remove it from todos
