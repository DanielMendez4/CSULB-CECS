...
public class FavoriteContactFrame extends JPanel{
	...
	*/
	public void paintComponent(Graphics g){
		  ...
		  g.drawString("Number: " + contactNumber, resizedImg.height + 200, 150);
		  g.drawString("Email: " + contactEmail, resizedImg.height + 200, 200);
		  g.drawString("Notes: " + contactNote, resizedImg.height + 200, 250);
	}
  ...
  public static void main(String arg[]){
	  ...
	  FavoriteContactFrame contact2 = new FavoriteContactFrame("C:\\Users\\Daniel\\Pictures\\Camera Roll\\PaintythePirate.jpg", fWidth, fHeight, "Painty the Pirate", "(800) ARR-RRRR", "davyjoneslocker@hotmail.com", "ARE YOU READY KIDS!?");
